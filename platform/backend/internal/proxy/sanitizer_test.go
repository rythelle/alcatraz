...
func TestSanitizeText_CreditCard(t *testing.T) {
	...
	if !strings.Contains(result.Output, "[REDACTED_BY_ALCATRAZ_CREDIT_CARD]") {
...
func TestSanitizeText_BRPhone(t *testing.T) {
	...
	if !strings.Contains(result.Output, "[REDACTED_BY_ALCATRAZ_PHONE]") {
...
func TestSanitizeText_Passport(t *testing.T) {
	...
	if !strings.Contains(result.Output, "[REDACTED_BY_ALCATRAZ_PASSPORT]") {
...
func TestSanitizeText_BankAccount(t *testing.T) {
	...
	if !strings.Contains(result.Output, "[REDACTED_BY_ALCATRAZ_BANK_ACCOUNT]") {
