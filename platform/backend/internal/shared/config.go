...
func LoadConfig() (*Config, error) {
	...
	viper.SetDefault("STATS_LOG_PATH", "/var/log/alcatraz/stats.jsonl")
	viper.SetDefault("GUARD_RULES_PATH", "/etc/alcatraz/guard-rules.yml")
	...
	return &Config{
		...
		StatsLogPath:   viper.GetString("STATS_LOG_PATH"),
		GuardRulesPath: viper.GetString("GUARD_RULES_PATH"),
