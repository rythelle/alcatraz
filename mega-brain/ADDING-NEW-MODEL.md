...
| `pre-compact.sh` | Claude Code (PreCompact) | digests the transcript tail into `mega-brain precompact`; prints `{}` |
...
| `mega-brain search "term"` | Recall on demand (grep project + global vault) |
